...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SalenNetwork") type = SalenNetwork;
    if(strType == "SalenNetworkVariable") type = SalenNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SalenNetwork) s = "SalenNetwork";
    if(type == SalenNetworkVariable) s = "SalenNetworkVariable";
