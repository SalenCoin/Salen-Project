...
This mechanism has been integrated into Bitcore-Node-Salen which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/salen/insight-api-salen#web-socket-api](https://github.com/salen/insight-api-salen#web-socket-api)
* API: [https://github.com/salen/insight-api-salen#instantsend-transactions](https://github.com/salen/insight-api-salen#instantsend-transactions)
...
By default, the Salen Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Salen Core daemon:
