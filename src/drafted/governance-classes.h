 ...
 *
 *   // network
 *   CSalenNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CSalenNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SalenNetwork
// //   -- signature requirements : Key1(User)
// class CSalenNetworkVariable : public CGovernanceObject
// {
// private:
