    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SLN-light"), QVariant("light"));
    ui->theme->addItem(QString("SLN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SLN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SLN-traditional"), QVariant("trad"));
