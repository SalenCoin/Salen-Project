    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Salen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Salen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and salen: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Salen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Salen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Salen Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Salen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Salen addresses"));
    ...
    openAction->setStatusTip(tr("Open a salen: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Salen Core help message to get a list with possible Salen Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Salen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Salen network", "", count));
}
...
{
    QString strTitle = tr("Salen Core"); // default title
