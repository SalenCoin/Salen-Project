...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9103", "127.0.0.1", 9103));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9103", "127.0.0.1", 9103));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9103", "::ffff:127.0.0.1", 9103));
    BOOST_CHECK(TestSplitHost("[::]:9103", "::", 9103));
    BOOST_CHECK(TestSplitHost("::9103", "::9103", -1));
    BOOST_CHECK(TestSplitHost(":9103", "", 9103));
    BOOST_CHECK(TestSplitHost("[]:9103", "", 9103));
