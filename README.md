...
Salen Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
[Tags](https://github.com/salen/salencore/tags) are created to indicate new official,
stable release versions of Salen Core.
