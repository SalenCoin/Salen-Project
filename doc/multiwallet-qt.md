...
Only requiring some minor changes is salen.cpp.
...
Changes to salen.cpp
----------------------
salen.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
