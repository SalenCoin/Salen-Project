...
Salen Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9103.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9102 for connections and services them.
...
However, in open source software such as Salen Core, where everyone uses
...
pay attention to for reviewers of Salen Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Salen Core uses tinyformat, which is type safe. Leave them out to avoid confusion
