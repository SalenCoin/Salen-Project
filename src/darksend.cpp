...
{
    if(fLiteMode) return; // ignore all Salen related functionality
...
/*
    ...
    allow endless transaction that would bloat Salen and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("salen-privatesend");
