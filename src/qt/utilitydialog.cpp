    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Salen Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Salen Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  salen-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Salen in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SLN, 0.1 SLN, 1 SLN and 10 SLN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.salen.com\">www.salen.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Salen Core is shutting down...") + "<br /><br />" +
